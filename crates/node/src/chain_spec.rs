...
use app_chain_runtime::{AuraConfig, EnableManualSeal, GenesisConfig, GrandpaConfig, SystemConfig, WASM_BINARY};
...
fn testnet_genesis(
    ...
    let starknet_genesis: app_chain_runtime::pallet_starknet::GenesisConfig<_> = genesis.into();
